...
/**
 * Parametrosacesso generated by hbm2java
 */
@Entity
@Table(name = "parametrosacesso", catalog = "fitdata")
public class Parametrosacesso implements java.io.Serializable {

	private ParametrosacessoId id;
	...
	public Parametrosacesso() {
	}

	public Parametrosacesso(ParametrosacessoId id, Empresa empresa,
			String descParam, char tipoParam, char flagSistema,
	...
	public Parametrosacesso(ParametrosacessoId id, Empresa empresa,
			String descParam, String valorParam, char tipoParam,
			char flagSistema, Integer valorRangeMin, Integer valorRangeMax,
			String valorPadrao, String listaValores, Date dataLogUpdate,
	...
	public ParametrosacessoId getId() {
		return this.id;
	}

	public void setId(ParametrosacessoId id) {
		this.id = id;
	}
	...
	@Column(name = "valorPadrao", length = 500)
